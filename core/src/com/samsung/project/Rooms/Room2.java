...
public class Room2 {
    ...
    public Room2(CastleRunner game, OrthographicCamera camera, GameScreen screen, ControlPanel controlPanel, ActiveRoom activeRoom) {
        this.game = game;
        this.camera = camera;
        this.screen = screen;
        ...
        map = new TmxMapLoader().load("maps/room_2.tmx");
        ...
        objectsBuilder.generateDoors(0, false);

        elevator = new Elevator(screen, world, 288, 96, 288, 240);
        enemy = new Enemy(world, screen, activeRoom, 64, 288, 224, 288, false);
    }

    public void createPlayer(int playerX, int playerY, int jump) {
        activeRoom.roomToRender = 2;
        screen.rooms[1] = true;
