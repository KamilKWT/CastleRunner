...
public class Room4 {
    ...
    public Room4(CastleRunner game, OrthographicCamera camera, GameScreen screen, ControlPanel controlPanel, ActiveRoom activeRoom) {
        this.game = game;
        this.camera = camera;
        this.screen = screen;
    ...
    public void update(float delta) {
        ...
        for (int i = 0; i < 2; i++) {
            i_walls[i].update(delta, 6, false);
        }
    }
